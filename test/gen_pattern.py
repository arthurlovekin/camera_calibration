...
"""gen_pattern.py
Source: https://github.com/opencv/opencv/blob/master/doc/pattern_tools/gen_pattern.py
Reference: https://docs.opencv.org/4.5.4/da/d0d/tutorial_camera_calibration_pattern.html
Usage example:
